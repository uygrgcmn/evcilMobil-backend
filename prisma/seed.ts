...
import { ListingType, PrismaClient, UserRole } from '@prisma/client';
...
async function main() {
  ...
  const demoPasswordHash = await hash('123456', 10);
  ...
  const ownerProfile = await prisma.ownerProfile.create({
    data: {
      ...
      city: 'Istanbul',
      avatarUrl:
        'https://lh3.googleusercontent.com/aida-public/AB6AXuB7E0VNdk4zB2SMN2HghbUaIPF56bTGzVgM6GDjumrenF3or_jdrVxS7cTtRsQjegd6Bx6UE9TJXDE5k65vsH97pTnEz_XyB_Bc5z7Nyrq3juMBZ0F-7jpyXSJ3U_pNYdAKqKPGlchOLNRwiERSzLNVQUsZ-BrgIVuJPPB9XS93pHeKcYxax9iMp7C1rgZOoDDV2C7dIbAAHgaB1N8Fauxs1HtCurTAuR5z93RQtdKXPHf74hFyjboUxwiBX8Aq_NyHdlhzgVcCyGkS',
      about:
        'I am a graphic designer who loves animals. I live in Istanbul with Pamuk and Max and value safe and joyful care when I travel.',
      averageRating: 4.9,
      pets: {
        create: [
          {
        ...
        create: [
          {
            ...
            rating: 5,
            comment:
              'Ayse was very kind and organized. It was a smooth and comfortable care process.',
          },
        ],
      },
    },
  ...
  const sitterSeeds = [
    {
      ...
      district: 'Besiktas',
      about:
        'Kopek gezdirme, evde bakim ve gece konaklama hizmetlerinde deneyimli bir bakiciyim. Her rezervasyonda duzenli gorsel guncelleme ve guvenli rutin takibi sagliyorum.',
      yearsExperience: 5,
      ...
      pricePerHour: 120,
      avatarUrl:
        'https://lh3.googleusercontent.com/aida-public/AB6AXuDOabkVOuZr41UpLU6Iowxsv1v8aLP82JHPHv8sIEVuuw7O5WledAgLuR2LKXzMeUZYkPwWr6GC0F1UMpmUrtiCEVqX6AysS9iuDCdcw8LVElUvZuWSXW2hNv2r-1e2tpG9Vb4i5ci95OYJDYY5eEOXAVZNxFsoTKq8M6Ptt0ispGlmXC6UxHJc6lzydll-PWPsnWsW2j52Qvkh0GCWKDBtFWTBzU5WlnJlV2Cd0mXhm8kT0hAtMPBElyN8d7V84fADzJ_ikWfwW7Xp',
      isFeatured: true,
    ...
    },
    {
      ...
      district: 'Kadikoy',
      about:
        'Evde konaklama ve gunluk bakim hizmetlerinde sakin, duzenli ve guvenli bir ortam sunuyorum. Ozellikle rutini seven dostlarla uyumlu calisiyorum.',
      yearsExperience: 4,
      identityVerified: true,
      repeatClientRate: 79,
      rating: 4.8,
      ...
      pricePerHour: 95,
      avatarUrl:
        'https://lh3.googleusercontent.com/aida-public/AB6AXuDX5PU29ffd3IRen0KM6ZaapYg-TtDnb4xGDSTSYU2PUtbmS6dnrcbltEtkYUyvaFzm6wTD9ii9gLF9gImrpZ930RED-Rk3IpVFcoFOQTI9ZRrXYgKbScOKYMHJY7ZbhVHO7d8lzT2PJKi1l3IUZBxeJlfgjbMy4DDj5cPehKVCFC2k6ZH_Is9dAMt2vKpzCtjnskPlmjDfECGvMOR4RAkWquqDRShKYJKXZiuVnEAA92_Cg-OufN_R5uS-7SUtgdpaWB62F_Go1c9j',
      isFeatured: true,
    ...
    },
    {
      ...
      district: 'Atasehir',
      about:
        'Ozellikle yuksek enerjili kopeklerle calismayi seviyorum. Her hizmette guvenli aktivite, duzenli raporlama ve net iletisim sunuyorum.',
      yearsExperience: 6,
      identityVerified: true,
      repeatClientRate: 88,
      rating: 5,
      ...
      pricePerHour: 150,
      avatarUrl:
        'https://lh3.googleusercontent.com/aida-public/AB6AXuClX4JbfbXkLLV9-RYZp233Gt6y5hpeZnG0vxI3zsItSY5ygwqizxRmvOF6cvSRCQUotzGR4YuKaYGfdZxOqYsHviIjZ3Fv8K_WhithY15hw5K2yT-EjcgcC8r8UpNooih7ChhWeRXKjFSTrJk34yXDXjBKAEevAwu7IWHIV9u3CO7bM0fNvUWz9dvCFZBqxt3Amo_lBcZWUuFdk5Sg9pRxpZz-04gNpnP45WheX55ImTMAvhHmDm2u16ytQ_U6UWmNq3MTzEyXxJqM',
      isFeatured: false,
      tags: ['walking'],
      galleryImageUrls: [
        'https://lh3.googleusercontent.com/aida-public/AB6AXuDtTuMnXJux1kl1DCMHxmh_0QUq2R3rHBrA8vdBxnZEkreSUE354TJ9bcoM7-Km8HHy-ncgYs6R6xZJKrzXO4CRbravS8x_iQo0khuOvj1PU6fSG7UszKmmeUfdAoAQvVqyLbCzVUismWz5ZcfxHnRJEreK-7BnxoT8gh-gsaLjtPEKFTfHLHNCNPglCFBnGXIVAYk1pZmGEj1crKN27H45qBzO08GOLVnFxE9v-CSQezRcq-wsA2Dx98D2hwxL3rJQKlG8mHroufDF',
  ...
  const dateFromOffset = (offsetMs: number) => new Date(Date.now() - offsetMs);
